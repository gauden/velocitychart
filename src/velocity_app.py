...
PALETTES = {
    ...
    "decrease_purple_increase_orange": [
        "#7f3b08",
        "#b35806",
        "#e08214",
        "#fdb863",
...
def velocity_color(value: float, palette_name: str, center: float, maximum: float) -> str:
    palette = list(reversed(PALETTES.get(palette_name, PALETTES["decrease_green_increase_red"])))
    if maximum <= 0:
        maximum = 1
...
def render_legend(palette_name: str) -> None:
    colors = list(reversed(PALETTES.get(palette_name, PALETTES["decrease_green_increase_red"])))
...
# ColorBrewer 2.0 color schemes by Cynthia A. Brewer,
# Geography, Pennsylvania State University. https://colorbrewer2.org/
PALETTES = {{
    "decrease_green_increase_red": ["#006837", "#1a9850", "#66bd63", "#a6d96a", "#d9ef8b", "#ffffbf", "#fee08b", "#fdae61", "#f46d43", "#d73027", "#a50026"],
    "decrease_blue_increase_red": ["#053061", "#2166ac", "#4393c3", "#92c5de", "#d1e5f0", "#f7f7f7", "#fddbc7", "#f4a582", "#d6604d", "#b2182b", "#67001f"],
    "decrease_teal_increase_brown": ["#003c30", "#01665e", "#35978f", "#80cdc1", "#c7eae5", "#f5f5f5", "#f6e8c3", "#dfc27d", "#bf812d", "#8c510a", "#543005"],
    "decrease_green_increase_pink": ["#276419", "#4d9221", "#7fbc41", "#b8e186", "#e6f5d0", "#f7f7f7", "#fde0ef", "#f1b6da", "#de77ae", "#c51b7d", "#8e0152"],
    "decrease_purple_increase_orange": ["#2d004b", "#542788", "#8073ac", "#b2abd2", "#d8daeb", "#f7f7f7", "#fee0b6", "#fdb863", "#e08214", "#b35806", "#7f3b08"],
}}
...
attach_events()
render_legend("decrease_green_increase_red")
set_status("Ready")
